...
import static com.example.rohitsahay.jauntbee20.JauntBeeConstants.Preferences.CONTACT_PREF;
import static com.example.rohitsahay.jauntbee20.JauntBeeConstants.Preferences.JAUNT_BEE_PREF;
        ...
        saveButton.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (allEmergencyContacts.isEmpty()) {
                    ...
                    Toast.makeText(ContactActivity.this, "Add atleast one emergency contact", Toast.LENGTH_SHORT).show();
                }
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (!"".equals(text)) {
                ...
                String delimiter = "\n";
                String screenSize = PhoneUtil.getScreenSizeName(ContactActivity.this);
            ...
            holder.addOrDeleteButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (tag != (myItems.size() - 1)) {
                        ...
                        if (holder.captionEditText.getText().toString().length() > 0) {
                            ...
                            Toast.makeText(ContactActivity.this, "Add a contact to this field first", Toast.LENGTH_SHORT).show();
                        }
